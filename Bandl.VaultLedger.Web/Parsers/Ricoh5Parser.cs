...
namespace Bandl.Library.VaultLedger.Parsers
{
    ...
    /// </summary>
    public class Ricoh5Parser : Parser, IParserObject
    {
        ...
        private bool MovePastListHeaders(StreamReader r1)
        {
            ...
            {
                if ((i = s1.IndexOf("RICOH Account #")) != -1)
                {
                    account_name = s1.Substring(i + "RICOH Account #".Length).Trim();
                }
        ...
        public override void Parse(byte[] fileText, out SendListItemCollection s1, out ReceiveListItemCollection r1, out ArrayList s, out ArrayList a, out ArrayList l)
        {
            ...
            {
                if (MovePastListHeaders(x1))        // ALWAYS RECEIVE LIST IN THIS PARSER
                {
                    IList i1 = (IList)r1;
