...
namespace Bandl.Library.VaultLedger.Parsers
{
    ...
    /// </summary>
    public class Sanofi2Parser : Parser, IParserObject
    {
        public Sanofi2Parser() {}
        ...
        private ListTypes MovePastListHeaders(StreamReader r)
        {
            ...
            {
                if (s1.ToUpper().IndexOf("BEING SENT OFF-SITE") != -1)
                {
                    x1 = ListTypes.Send;
                    b1 = true;
                }
                else if (s1.ToUpper().IndexOf("ARE TO BE RETURNED") != -1)
                {
