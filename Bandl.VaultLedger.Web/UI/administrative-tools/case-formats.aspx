<%@ Page language="c#" Codebehind="case-formats.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.case_formats" %>
...
<HTML>
    <HEAD>
        ...
        function renderTable()
        {
            ...
            // Add the row
            addRow(format, typeName, checkStatus);
        ...
        function toggleCheck(checkBox)
        {
            ...
            var s = c[1].firstChild.innerHTML + '`' + c[2].innerHTML + '`';
        ...
        function deleteRows()
        {
            ...
            if (tableRow.getElementsByTagName('input')[0].checked)
            {
                ...
                var s = format + '`' + typeName + '`1;'
                o.value = o.value.replace(s, '');
            }
            }
            // Renumerate checkboxes
            for (i = 1; i < theTable.rows.length-1; i += 1)
            {
        ...
        // Function: addRow
        //
        function addRow(format, typeName, checkStatus)
        {
            var theTable = getObjectById('DataGrid1');
            // Create the new row         
            var rowNo = 0;
            ...
            // Create the checkbox.  If the pattern is '.*', then
            // insert a blank node instead.
            if (format != '.*')
            {
            ...
            hyperLink.href = "javascript:displayBox('" + format + "','" + typeName + "'," + rowNo.toString() + ");";
            ...
            if (format != '.*') cell1.firstChild.checked = checkStatus == '1';
        }
        //
        // Function: moveUp
        //
        function moveUp()
        {
            ...
            // Move all checked items that occur after the first unchecked
            // item up one spot.
            for (i = firstUnchecked + 1; i < theTable.rows.length-1; i++)
            {
        ...
        // Function: displayBox
        //
        function displayBox(format, typeName, nval)
        {
            n = nval;
            var i = -1;
            var o1 = getObjectById('ddlTypes');
            ...
            if (format == '.*')
//            if (getObjectById('DataGrid1').rows.length - 1 == nval)
            {
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    <h1>Case Formats</h1>
                    These are the bar code formats that determine the case type for each 
                    case when it is added to the system.&nbsp;&nbsp;To define a new bar code format, click New Format.
                ...
                <div class="contentArea" id="contentBorderTop">
                    <div class="contentBoxTop">
                        ...
                        </asp:dropdownlist>&nbsp;&nbsp; <input class="formBtn btnSmallGo" id="btnGo" onclick="javascript:eventGo();" type="button"
                            value="Go">
                    ...
                    <div class="content">
                        <asp:datagrid id="DataGrid1" runat="server" CssClass="detailTable" EnableViewState="False" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkColumn DataNavigateUrlFormatString="#" DataTextField="Pattern" HeaderText="Case Format">
            ...
            <input id="tableContents" type="hidden" runat="server" NAME="tableContents"> 
            <!-- BEGIN SAVE MESSAGE BOX -->
            <div class="msgBoxSmall" id="msgBoxSave" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Case formats were updated successfully.</div>
            ...
            <div class="msgBox" id="msgBoxAssign" style="DISPLAY:none">
                ...
                <div class="msgBoxBody">
                    Please enter the case format information:
                    <br>
                    <br>
                    <table style="width:100%">
                        ...
                        <tr height="27">
                            <td align="right" style="PADDING-RIGHT:11px">Case type:</td>
