...
{
	/// <summary>
	/// Summary description for list_email.
	/// </summary>
	public class list_email : BasePage
	{
        ...
        protected override void Event_PageLoad(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                TabPageDefault.Update(TabPageDefaults.ListPreferences, Session[CacheKeys.CurrentLogin], 2);
            }
        }
        /// <summary>
        ...
        protected override void Event_PagePreRender(object sender, System.EventArgs e)
        {
            ...
            {
                case ListTypes.Send:
                    this.lblTitle.Text = "List Status Email Notifications&nbsp;&nbsp;-&nbsp;&nbsp;Shipping";
                    break;
                case ListTypes.Receive:
                    this.lblTitle.Text = "List Status Email Notifications&nbsp;&nbsp;-&nbsp;&nbsp;Receiving";
                    break;
                case ListTypes.DisasterCode:
                    this.lblTitle.Text = "List Status Email Notifications&nbsp;&nbsp;-&nbsp;&nbsp;Disaster Recovery";
                    break;
            }
        }
        #endregion
        ...
        {
            Server.Transfer("email-configure.aspx?redirectPage=list-email.aspx&listType=" + ((int)listType).ToString());        
        }
    }
}
