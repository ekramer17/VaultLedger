<%@ Page language="c#" Codebehind="new-compare-receive-list-manual-scan.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.new_compare_receive_list_manual_scan" %>
    ...
    <body onload="javascript:initializePage()">
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                ...
                <!-- Should be visible when RFID is enabled -->
                ...
                <!-- Should be visible when RFID is not enabled -->
                <div id="twoTabs" class="tabNavigation threeTabs" runat="server">
                ...
                <div class="contentArea">
                    <div id="accountDetail">
                        ...
                        <table cellSpacing="0" cellPadding="0" border="0">
                            <tr>
                                <td width="143" height="23">Serial/Case Number:</td>
                    ...
                    <div class="contentArea" id="todaysList" runat="server">
                        ...
                        <asp:datagrid id="DataGrid1" runat="server" CssClass="detailTable" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="SerialNo" HeaderText="Serial/Case Numbers">
                                    <HeaderStyle Font-Bold="True"></HeaderStyle>
                                </asp:BoundColumn>
                            </Columns>
                        </asp:datagrid>
                        <div class="contentBoxBottom">
                            <input id="btnSave" type="button" runat="server" class="formBtn btnSmall" value="Save">
        ...
        function deleteRows()
        {
           ...
           // Renumerate checkboxes and set row css classes
        ...
        function clickAdd()
        {
           ...
           addRow(serialBox.value,'0');
           serialBox.focus();      
        }  
        //
        // Function: addRow
        //
        function addRow(serialNo, checkStatus)
        {
           ...
           // Make sure serial number does not already exist in table.  If it does, return.
           for (i = 1; i < theTable.tBodies[0].rows.length; i++)
           ...
           // Append to the hidden element (serialNo|checked;)
           hiddenElem.value += serialNo + '|' + checkStatus + ';';
