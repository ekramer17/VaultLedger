<%@ Page language="c#" Codebehind="new-receive-list-rfid-file.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.new_receive_list_rfid_file" %>
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    ...
                    RFID output file, enter the full path of the file and click OK.
                </div> <!-- end pageHeader //-->
                <asp:PlaceHolder id="PlaceHolder1" runat="server" EnableViewState="False"></asp:PlaceHolder>
                <div class="tabNavigation threeTabs">
                    <div class="tabs" id="threeTabOne"><a href="new-receive-list-manual-scan-step-one.aspx">Manual 
                            / Scan</a></div>
                    <div class="tabs" id="threeTabTwo"><a href="new-receive-list-tms-file.aspx">TMS 
                            Report</a></div>
                    <div class="tabs" id="threeTabThreeSelected"><A href="#">Imation RFID</A></div>
                </div>
