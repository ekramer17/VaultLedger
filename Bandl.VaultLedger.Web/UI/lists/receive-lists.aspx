<%@ Page language="c#" Codebehind="receive-lists.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.receive_lists" %>
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    <h1>Receiving Lists</h1>View the details of a particular
                    receiving list by clicking a list name, or perform an action on one or more
                    lists by selecting them, choosing the action, and clicking Go.
                    ...
                    <table class="detailTable">
                        <tr>
                            <td align="left"><asp:linkbutton id="lnkPageFirst" tabIndex="14" runat="server" Text="[First Page]" OnCommand="LinkButton_Command" CommandName="pageFirst">[<<]</asp:linkbutton>&nbsp;
                                ...
                                <asp:textbox id="txtPageGoto" tabIndex="16" runat="server" Width="40px"></asp:textbox><input id="enterGoto" type="hidden" runat="server" NAME="enterGoto">
            ...
            <div class="msgBox" id="msgBoxDelete" style="DISPLAY: none">
                ...
                <div class="msgBoxBody">
                    Deleting a list permanently removes it from the database.
                    <br><br>
