<%@ Page language="c#" Codebehind="receiving-compare-online-reconcile.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.receiving_compare_online_reconcile" %>
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    ...
                    <table cellSpacing="0" cellPadding="0" border="0">
                        <tr>
                            ...
                            <td width="150"><b>Items Added:</b>&nbsp;&nbsp;<asp:label id="lblItemsMoved" runat="server">0</asp:label></td>
                        </tr>
                        <tr>
                ...
                <div id="twoTabs" class="tabNavigation twoTabs" runat="server">
                    ...
                    <div class="tabs" id="twoTabTwo"><A href="javascript:redirectPage('receiving-list-reconcile.aspx?listNumber=' + getObjectById('lblListNo').innerHTML);">Batch 
                            Reconcile</A></div>
                </div>
                ...
                <div class="topContentArea">
                    <div id="divSerial" style="MARGIN-TOP: 10px; MARGIN-BOTTOM: 10px" runat="server">
                        ...
                        <asp:label id="serialLabel" runat="server" Font-Bold="True">Serial/Case Number:</asp:label>&nbsp;&nbsp;
                        <asp:textbox id="txtSerialNum" runat="server" CssClass="medium"></asp:textbox></div>
...
<div class="msgBox" id="msgBoxAdd" style="DISPLAY: none">
    <h1><%= ProductName %></h1>
    <div class="msgBoxBody">Medium&nbsp;<asp:label id="lblAddSerial" runat="server"></asp:label>&nbsp;is 
        not currently on the list.<br>
        <br>
        Would you like to add it to the list now?
    </div>
    <div class="msgBoxFooter"><asp:button id="btnAddYes" runat="server" CssClass="formBtn btnSmallTop" Text="Yes"></asp:button>&nbsp;
        <input class="formBtn btnSmallTop" id="btnAddNo" onclick="hideMsgBox('msgBoxAdd');getObjectById('txtSerialNum').value = '';getObjectById('txtSerialNum').select()" type="button" value="No">
    </div>
</div>
<!-- END ADD MEDIUM MESSAGE BOX -->
            ...
            <div class="msgBoxSmall" id="msgBoxEmpty" style="DISPLAY: none">
                ...
                <div class="msgBoxFooter"><input class="formBtn btnSmallTop" onclick="location.href='receive-lists.aspx'" type="button"
                        value="OK"></div>
            </div>
            <!-- BEGIN MOVE MEDIUM MESSAGE BOX -->
            <div class="msgBox" id="msgBoxMove" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody"><asp:label id="lblSerialNo" runat="server"></asp:label>&nbsp;is 
                    not on the list.
                    <br>
                    <br>
                    Would you like to move it to the enterprise now?
                </div>
                <div class="msgBoxFooter">
                    <asp:button id="btnYes" runat="server" CssClass="formBtn btnSmallTop" Text="Yes"></asp:button>
                    &nbsp; <input type="button" class="formBtn btnSmallTop" value="No" onclick="hideMsgBox('msgBoxMove');getObjectById('txtSerialNum').value='';getObjectById('txtSerialNum').focus">
                </div>
            </div>
            <!-- END MOVE MEDIUM MESSAGE BOX -->
            <!-- BEGIN NO ADD MESSAGE BOX -->
            <div class="msgBox" id="msgBoxNoAdd" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody"><asp:label id="lblSerialNoAdd" runat="server"></asp:label>&nbsp;is 
                    not on the list, and tapes cannot be added to a list with
                    <asp:label id="lblStatusNoAdd" runat="server"></asp:label>&nbsp;status.
                    <br>
                    <br>
                    If you wish to move this tape to the vault, please create another list.
                </div>
                <div class="msgBoxFooter"><asp:button id="btnOkNoAdd" runat="server" CssClass="formBtn btnSmallTop" Text="OK"></asp:button></div>
            </div>
            <!-- END MOVE MEDIUM MESSAGE BOX -->
            ...
            <!-- END SEALED REMOVAL MESSAGE BOX -->
            <!-- BEGIN RECONCILE MESSAGE BOX -->
            <div class="msgBoxSmall" id="msgBoxVerify" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Receiving list
                    <%= ListName %>
                    has been fully verified.</div>
                <div class="msgBoxFooter"><input class="formBtn btnSmallTop" id="btnOK" type="button" value="OK" name="btnOK" runat="server"></div>
            </div>
            ...
            <div class="msgBox" id="msgBoxMissing" style="DISPLAY: none">
                ...
                <div class="msgBoxBody">At least one of the media checked resides in a sealed case.
                    ...
                    its case), or designate all media in the case as missing.
                    <br>
                    <br>
            ...
            <!-- Hidden fields //--><input id="tableContents" type="hidden" name="tableContents" runat="server">
            <input id="unverifiedTapes" type="hidden" name="unverifiedTapes" runat="server">
            <input id="alreadyVerified" type="hidden" name="alreadyVerified" runat="server">
            <input id="verifyThese" type="hidden" name="verifyThese" runat="server"> <input id="caseSerials" type="hidden" name="caseSerials" runat="server">
            <input id="totalItems" type="hidden" name="totalItems" runat="server"> <input id="pageValues" type="hidden" name="pageValues" runat="server"> <!--// page number;items per page --><input id="checkThis" type="hidden" name="checkThis" runat="server">
            <input id="sealedTape" type="hidden" runat="server"><input id="verifyStage" type="hidden" runat="server">
        </form>
        <!-- Javascript //-->
        ...
        //          -1 if tape not in unverified control
        //          -2 if tape in sealed case and verify stage = 1
        //
        function verifyTape(serialNo, ignoreCase)
        {
            ...
            if (!ignoreCase && getObjectById('verifyStage').value == '1' && sealedTape(serialNo))
            {
                getObjectById('txtSerialNum').select();
                return -2;
            }
