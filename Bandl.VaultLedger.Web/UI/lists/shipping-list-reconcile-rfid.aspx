<%@ Page language="c#" Codebehind="shipping-list-reconcile-rfid.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.shipping_list_reconcile_rfid" %>
    ...
    <HEAD>
        ...
        function reportRfidTagInfo(appletString)
        {
            ...
            if (readyState != false && appletString.length != 0)
            {
                ...
                // a case, evaluate it; otherwise go straight to evaluating.
        ...
        function doManual()
        {
            // Get the serial number and case name in the textboxes
            var serialNo = getObjectById('txtSerialNo').value;
            var caseSerial = getObjectById('txtCaseName').value;
            // If the ready state is false or no applet string then just return
            if (readyState != false && serialNo.length != 0)
            {
                ...
                tapes2 = new Array();
                // Collect the rfid info
                if (caseSerial.length != 0)
                {
                    collectRfidInfo(serialNo + '&0&UNIQUEID;' + caseSerial + '&1&UNIQUEID2');
                }
                else
                {
        ...
        function doCase()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        getObjectById('unrecognizedCase1').innerHTML = caseName;
                        getObjectById('unrecognizedCase2').innerHTML = caseName;
                        showMsgBox('msgBoxUnrecognizedCase1');
                    }
                }
            }
        }
            ...
            if (index < tapes2.length)
            {
                switch (action)
                {
                    case 0:
                        ...
                        getObjectById('newTapeButtons1').style.display = manual ? 'none' : 'block';
                        getObjectById('newTapeButtons2').style.display = manual ? 'block' : 'none';
                        // Show the box
                    ...
                    case 2:                       
                        ...
                        getObjectById('unrecognizedTapes').value += tapes2[index] + '`' + caseName + '`' + getObjectById('txtReturnDateTape').value + '`1;';
        ...
        function displaySwitch(serialNo, case1, case2) // tape serial number, old case, new case
        {
            if (case2.length != 0)
            {
                ...
                getObjectById('switchButtons1').style.display = manual ? 'none' : 'block';
                getObjectById('switchButtons2').style.display = manual ? 'block' : 'none';
                // Show it                
            ...
            else
            {
                ...
                // Which set of buttons?
                getObjectById('removeButtons1').style.display = manual ? 'none' : 'block';
                getObjectById('removeButtons2').style.display = manual ? 'block' : 'none';
                // Show it                
            ...
            else 
            {
                switch (onStartup)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        location.href = 'shipping-list-detail.aspx?listNumber=' + getObjectById('lblListNo').innerHTML;
                        break;
                    default:
                        readyState = true;
                        break;
    ...
    <body>
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    ...
                    <table cellSpacing="0" cellPadding="0" border="0">
                        ...
                        <tr>
                            <td colSpan="4"><b>Last Scanned:</b>&nbsp;&nbsp;<asp:label id="lblLastItem" runat="server" CssClass="introHeader"></asp:label></td>
                        </tr>
                    </table>
                    <div id="headerConstants">
                        <A class="headerLink" id="listLink" style="LEFT: 644px" href="javascript:redirectPage('shipping-list-detail.aspx?listNumber=' + getObjectById('lblListNo').innerHTML);">
                            List Detail</A>
                    </div>
                </div> <!-- end pageHeader //-->
                    ...
                    <div style="MARGIN-TOP: 10px; MARGIN-BOTTOM: 10px">
                        <table width="100%">
                            <tr height="23">
                                ...
                                <td width="60%">
                                    <asp:textbox id="txtSerialNo" runat="server" CssClass="medium" TabIndex="1"></asp:textbox>
                                </td>
                                <td width="40%" rowspan="2" valign="middle" align="right">
                                    <input type="button" value="Verify" class="formBtn btnMedium" id="btnVerify" onclick="doManual()"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:textbox id="txtCaseName" runat="server" CssClass="medium" TabIndex="2"></asp:textbox>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="msgBoxSmall" id="msgBoxVerified" style="DISPLAY: none">
                ...
                <div class="msgBoxFooter"><input class="formBtn btnSmallTop" id="btnOK" onclick="hideMsgBox('msgBoxVerified');redirectPage('shipping-list-detail.aspx?listNumber=' + getObjectById('lblListNo').innerHTML);"
            ...
            <div class="msgBoxSmall" id="msgBoxDeleted" style="DISPLAY: none">
                ...
                <div class="msgBoxFooter"><input class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxDeleted');redirectPage('send-lists.aspx');"
                        type="button" value="OK">
                </div>
            </div>
            ...
            <div class="msgBoxSmall" id="msgBoxUnrecognizedCase1" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Case&nbsp;<span id="unrecognizedCase1"></span>&nbsp;does 
                    not appear on the list.<br>
                    <br>
                    Would you like to proceed with scans of this case?
                </div>
                <div class="msgBoxFooter">
                    <input class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxUnrecognizedCase1');showMsgBox('msgBoxUnrecognizedCase2');"
                        type="button" value="Yes"> &nbsp; <input class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxUnrecognizedCase1');getObjectById('unrecognizedCases').value += getObjectById('unrecognizedCase1').innerHTML + '``0`0;';readyState=true;"
                        type="button" value="No">
                </div>
            </div>
            <!-- END UNRECOGNIZED CASE MESSAGE BOX -->
            <!-- BEGIN UNRECOGNIZED CASE SPECS MESSAGE BOX -->
            <div class="msgBox" id="msgBoxUnrecognizedCase2" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Please supply the specifications for case&nbsp;<span id="unrecognizedCase2"></span>.
                    <table cellSpacing="0" cellPadding="0" width="240" align="center" border="0" style="MARGIN-TOP:21px">
                        <tr>
                            <td align="center">
                                Selected: &nbsp; &nbsp;
                                <select style="WIDTH:60px" id="sealedBox" onchange="getObjectById('tblCaselReturnDate').style.display = selectedIndex != 0 ? 'none' : 'block'">
                    ...
                    <table id="tblCaselReturnDate" cellSpacing="0" cellPadding="0" width="240" align="center"
                        border="0" style="MARGIN-TOP:15px; DISPLAY:none">
                        <tr>
                            <td style="WIDTH: 31%" align="left">Return Date:</td>
                            <td style="WIDTH: 55%" align="left"><input type="text" id="txtReturnDateCase" style="WIDTH:92%"></td>
                            <td class="calendarCell"><A class="iconLink calendarLink" id="calendar2" href="javascript:openCalendar('txtReturnDateCase');"></A></td>
                        </tr>
                    </table>
                </div>
                <div class="msgBoxFooter">
                    <input class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxUnrecognizedCase2');getObjectById('unrecognizedCases').value += getObjectById('unrecognizedCase2').innerHTML + '`' + getObjectById('txtReturnDateCase').value + '`' + (getObjectById('sealedBox').selectedIndex != 0 ? '0' : '1') + '`1;';doTapes1(action1);"
                        type="button" value="OK"> &nbsp; <input class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxUnrecognizedCase2');getObjectById('unrecognizedCases').value += getObjectById('unrecognizedCase2').innerHTML + '``0`0;';readyState=true;"
                        type="button" value="Cancel">
                </div>
            </div>
            <!-- END UNRECOGNIZED CASE SPECS MESSAGE BOX -->
            <!-- BEGIN UNRECOGNIZED TAPE MESSAGE BOX -->
            <div class="msgBox" id="msgBoxUnrecognizedTape" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Medium&nbsp;<span id="unrecognizedTape"></span>&nbsp;does 
                    not appear on list.<br>
                    <br>
                    ...
                    <table cellSpacing="0" cellPadding="0" width="240" align="center" border="0">
                        <tr>
                            <td style="WIDTH: 31%" align="left">Return Date:</td>
                            <td style="WIDTH: 55%" align="left"><input type="text" id="txtReturnDateTape" style="WIDTH:92%"></td>
                            <td class="calendarCell"><A class="iconLink calendarLink" id="calendar1" href="javascript:openCalendar('txtReturnDateTape');"></A></td>
                        </tr>
                    </table>
                </div>
                <div class="msgBoxFooter">
                    <div id="newTapeButtons1">
            ...
            <!-- BEGIN CASE SWITCH MESSAGE BOX -->
            <div class="msgBox" id="msgBoxCaseSwitch" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">
                    Medium&nbsp;<span id="switchTape"></span><span id="switchSituation"></span><span id="switchCase1"></span>&nbsp;but 
                    was scanned in case&nbsp;<span id="switchCase2"></span>.<br>
                    <br>
                    Would you like to switch the case for this medium?
                </div>
                <div class="msgBoxFooter">
                    <div id="switchButtons1">
                        <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseSwitch');doSwitch(getObjectById('switchTape').innerHTML, getObjectById('switchCase1').innerHTML, getObjectById('switchCase2').innerHTML);"
                            value="Yes"> &nbsp; <input type="button" class="formBtn btnSmallTopPlus" onclick="hideMsgBox('msgBoxCaseSwitch');action1 = (action1 | 0x04) &amp; 0x0E;doSwitch(getObjectById('switchTape').innerHTML, getObjectById('switchCase1').innerHTML, getObjectById('switchCase2').innerHTML);"
                            value="Yes To All"> &nbsp; <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseSwitch');doTapes1(action1);"
                            value="No"> &nbsp; <input type="button" class="formBtn btnSmallTopPlus" onclick="hideMsgBox('msgBoxCaseSwitch');doTapes1(action1 &amp; 0x0A);"
                            value="No To All">
                    </div>
                    <div id="switchButtons2">
                        <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseSwitch');doSwitch(getObjectById('switchTape').innerHTML, getObjectById('switchCase1').innerHTML, getObjectById('switchCase2').innerHTML);"
                            value="Yes"> &nbsp; <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseSwitch');doTapes1(action1);"
                            value="No">
                    </div>
                </div>
            </div>
            <!-- END CASE SWITCH MESSAGE BOX -->
            <!-- BEGIN CASE REMOVAL MESSAGE BOX -->
            <div class="msgBox" id="msgBoxCaseRemove" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">
                    Medium&nbsp;<span id="removeTape"></span>&nbsp;was listed in case&nbsp;<span id="removeCase"></span>&nbsp;but 
                    was scanned without an accompanying case.<br>
                    <br>
                    Would you like to remove the medium from its case?
                </div>
                <div class="msgBoxFooter">
                    <div id="removeButtons1">
                        <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseRemove');doSwitch(getObjectById('removeTape').innerHTML, getObjectById('removeCase').innerHTML, '');"
                            value="Yes"> &nbsp; <input type="button" class="formBtn btnSmallTopPlus" onclick="hideMsgBox('msgBoxCaseRemove');action1 = (action1 | 0x08) &amp; 0x0D;doSwitch(getObjectById('removeTape').innerHTML, getObjectById('removeCase').innerHTML, '');"
                            value="Yes To All"> &nbsp; <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseRemove');doTapes1(action1);"
                            value="No"> &nbsp; <input type="button" class="formBtn btnSmallTopPlus" onclick="hideMsgBox('msgBoxCaseRemove');doTapes1(action1 &amp; 0x05);"
                            value="No To All">
                    </div>
                    <div id="removeButtons2">
                        <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseRemove');doSwitch(getObjectById('removeTape').innerHTML, getObjectById('removeCase').innerHTML, '');"
                            value="Yes"> &nbsp; <input type="button" class="formBtn btnSmallTop" onclick="hideMsgBox('msgBoxCaseRemove');doTapes1(action1);"
                            value="No">
                    </div>
                </div>
            </div>
            ...
            <!-- END CASE REMOVAL MESSAGE BOX -->
            <!-- BEGIN SEALED CASE REMOVAL MESSAGE BOX  : USED IN STAGE II VERIFICATION-->
            <!--            
            <div class="msgBox" id="msgBoxSealed" style="DISPLAY: none">
                <h1><%= ProductName %></h1>
                <div class="msgBoxBody">Medium&nbsp;<asp:label id="lblSealedTape1" runat="server"></asp:label>&nbsp;is 
                    in a sealed case, so you should not have been able to reconcile it 
                    individually.
                    <br>
                    <br>
                    Would you like
                    ...
                    <br>
                    <br>
                    Please note that if you choose not to remove&nbsp;<asp:label id="lblSealedTape2" runat="server"></asp:label>&nbsp;from 
                    its case, it will be verified only when its case is verified.
                </div>
                <div class="msgBoxFooter"><input class="formBtn btnSmallTop" id="btnSealedYes" type="button" value="Yes" name="btnSealedYes"
                        runat="server"> &nbsp; <input class="formBtn btnSmallTop" id="btnSealedNo" onclick="hideMsgBox('msgBoxSealed');getObjectById('sealedTape').value='';"
                        type="button" value="No">
                </div>
            </div>
-->
            <!-- END SEALED CASE REMOVAL MESSAGE BOX -->
            <!-- BEGIN MANUAL MOVE MESSAGE BOX : USED IN STAGE II VERIFICATION -->
            <!--            
            <div class="msgBox" id="msgBoxMove" style="DISPLAY: none">
                ...
                <div class="msgBoxFooter"><asp:button id="btnMove" runat="server" CssClass="formBtn btnSmallTop" Text="Yes"></asp:button>&nbsp;
                    <input class="formBtn btnSmallTop" id="btnNoMove" onclick="hideMsgBox('msgBoxMove');" type="button"
                        value="No">
                </div>
            </div>
-->
            <!-- END MANUAL MOVE MESSAGE BOX -->
            <!-- Hidden fields //-->
