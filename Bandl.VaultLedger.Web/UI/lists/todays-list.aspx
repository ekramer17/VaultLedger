<%@ Page language="c#" Codebehind="todays-list.aspx.cs" AutoEventWireup="false" Inherits="Bandl.VaultLedger.Web.UI.todays_list" %>
        ...
        <form id="Form1" method="post" runat="server">
            <div class="contentWrapper">
                <div class="pageHeader">
                    ...
                    list.
                    <div id="headerConstants"><asp:linkbutton CssClass="headerLink" runat="server" id="printLink">Print</asp:linkbutton>
                    </div></div><!-- end pageHeader //--><asp:placeholder id="PlaceHolder1" runat="server" EnableViewState="False"></asp:placeholder>
                <div class="tabNavigation twoTabs">
                    <div class="tabs" id="twoTabOneSelected"><A href="todays-list.aspx">Today's Shipping
                            Lists</A></div>
                    <div class="tabs" id="twoTabTwo"><A href="todays-receiving-list.aspx">Today's Receiving
                            Lists</A></div></div>
                <div class="contentArea contentBorderTopNone">
                    <div class="contentBoxTop">
                        <div class="floatRight">
                            <asp:button id="btnNew" runat="server" Text="New List" CssClass="formBtn btnSmallTopPlus"></asp:button>
                        </div>
                    ...
                    <!-- end content //--></div><!-- end contentArea //--></div>
            <!-- end contentWrapper //-->
